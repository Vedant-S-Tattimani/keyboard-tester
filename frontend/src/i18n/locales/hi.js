export const hi = {
  ...
  // Home
  'home.title': 'अपना कीबोर्ड टेस्ट करें',
  'home.subtitle': 'अपने कीबोर्ड का ऑनलाइन फ्री टेस्ट करें और प्रत्येक कुंजी को रियल टाइम में जांचें।\nकिसी भी गैर-जिम्मेदार, अटकी या खराब काम करने वाली की (key) को सीधे अपने ब्राउज़र में पहचानें।',
  ...
  'seo.home.title': 'कीबोर्ड टेस्ट – ऑनलाइन कीबोर्ड टेस्टर और की चेक | KeyCheck',
  'seo.home.desc': 'मुफ्त में अपने कीबोर्ड का ऑनलाइन टेस्ट करें। हर कुंजी (key) को रियल-टाइम में चेक करें और अटकी या खराब कीज़ का तुरंत पता लगाएं।',
  'seo.ghostingtest.title': 'कीबोर्ड घोस्टिंग टेस्ट – ऑनलाइन की रोलओवर टेस्ट करें | KeyCheck',
  'seo.ghostingtest.desc': 'एक साथ कीबोर्ड इनपुट का परीक्षण करें और देखें कि आपका ब्राउज़र एक बार में कितनी कुंजियाँ प्राप्त कर सकता है।',
  'seo.typingtest.title': 'टाइपिंग टेस्ट – अपनी WPM गति और सटीकता जाँचें | KeyCheck',
  'seo.typingtest.desc': 'हमारे ऑनलाइन टाइपिंग टेस्ट के साथ अपनी टाइपिंग गति (WPM) और सटीकता मापें। विभिन्न अनुच्छेदों के साथ अभ्यास करें।',
  'seo.inspector.title': 'कीबोर्ड इवेंट इंस्पेक्टर – ब्राउज़र रॉ इवेंट्स जाँचें | KeyCheck',
  'seo.inspector.desc': 'वेब डेवलपर्स के लिए की, कोड, स्थान और संशोधक स्थिति सहित रॉ ब्राउज़र कीबोर्ड घटनाओं का निरीक्षण करने के लिए उन्नत उपकरण।',
  'seo.compare.title': 'कीबोर्ड की तुलना करें – कवरेज और इनपुट की जाँच | KeyCheck',
  'seo.compare.desc': 'अलग-अलग कीबोर्ड परीक्षण करें और कवरेज और अनुपलब्ध कुंजियों जैसे ब्राउज़र-अवलोकन योग्य परिणामों की तुलना करें।',
